...
//TODO: Fix the PATCH request for updating the profile
//TODO: Fix the UPLOAD request for uploading the profile image
const Profile = () => {
  const { auth } = useAuth();
  ...
  const handleImageUpload = async (e: { preventDefault: () => void; }) => {
    ...
    try {
      ...
      const response = await axiosPrivate.post(
        ...
        formData, // Pass the formData instead of JSON.stringify
        {
          headers: {
                ...
                <form onSubmit={handleProfileUpdate}>
                  ...
                  <div className="mb-5.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        className="w-full rounded border border-stroke bg-customGray py-3 pl-11.5 pr-4.5 text-black focus:border-primary active:border-primary disabled:cursor-default focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                        type="email"
                        name="emailAddress"
                        id="emailAddress"
                        disabled
            ...
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              ...
              <div className="p-7">
                <form action="#" onSubmit={handleImageUpload}>
                  ...
                  <div
                    id="FileUpload"
                    className="relative mb-5.5 block w-full cursor-pointer appearance-none rounded border border-dashed border-primary bg-customGray py-4 px-4 dark:bg-meta-4 sm:py-7.5"
                  >
                    <input
                      type="file"
                    ...
                    <div className="flex flex-col items-center justify-center space-y-3">
                      {image ? (
                        <Image src={image} alt="Selected Image" className="rounded-full" />
                      ) : (
                        <span className="flex h-10 w-10 items-center justify-center rounded-full border border-stroke bg-white dark:border-strokedark dark:bg-boxdark">
                          <AiOutlineUpload className="text-primary text-xl" />
                        </span>
                      )}
                      <p>
